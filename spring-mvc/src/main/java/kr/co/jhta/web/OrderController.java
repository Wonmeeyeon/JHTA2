...
public class OrderController {
	...
	// (요청방식:GET, 요청 URL:/order/step2.do, 요청파라미터:없음)
	@GetMapping("/step2.do")
	public String step2() {
		return "order/step2";
	}
	...
	//결제방법, 계좌번호 입력 후 폼 입력값을 제출했을 때 실행됨
	...
	// 수령자 이름, 전화번호, 주소입력 후 폼 입력값을 제출했을 때 실행됨
	// (요청방식:POST, 요청URL:/order/step3.do, 요청파라미터:receiverName, receiverTel)
	...
	// 4단계화면(구매상품정보, 구매자정보,결제정보, 수령인 정보 표시화면)
	// 주문내용을 확인하고 주문버튼을 클릭했을때 실행된
